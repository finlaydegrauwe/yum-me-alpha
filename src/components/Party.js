  ...
  async function checkGuest() {
    ...
    if (re.test(guestToAdd)) {
        let { data, error } = await supabase.rpc('send_email_message',{message:{
          ...
          "subject": "You've been invited by "+creator+" for a Yum-me dinner party!",
